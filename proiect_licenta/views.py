...
def post_list(request):
    ...
    return render(request, 'proiect_licenta/post_list.html', {'posts': posts})
...
def post_item(request, pk):
    ...
    return render(request,'proiect_licenta/post_item.html', {'post': post})
...
def add_comment_to_post(request, pk):
    ...
    if request.method == "POST":
        ...
        form = CommentForm()
    return render(request, 'proiect_licenta/comment_form.html', {'form': form})
...
def profile_page(request, username):
    ...
    return render(request, 'proiect_licenta/user_account.html', {'profile_user': user, 'comments': comments})

def viewed_profile(request, comment_author):
    profile_user = User.objects.get(username=comment_author)
    print(profile_user)
    return render(request, 'proiect_licenta/viewed_user.html', {'profile_user': profile_user})
...
def register(request):
    ...
    return render(request,'proiect_licenta/registration.html',
                          {'user_form':user_form,
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            #return HttpResponse("Credentiale invalide! Incercati din nou.")
            #return render(request, 'proiect_licenta/login.html', {'errors': errors})
            messages.error(request,'Username or password not correct')
            return redirect('user_login')
    else:
        return render(request, 'proiect_licenta/login.html', {})
...
def edit_profile(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'proiect_licenta/user_account.html', args)
    #else:
        #print('22222')
        #user_profile, created = UserProfileInfo.objects.get_or_create(user=request.user)
        #form = EditProfileForm(instance=request.user)
        #update_profile_form = UserProfileInfoForm(instance=user_profile)

    #args = {'form': form, 'update_profile_form': update_profile_form}
    #return render(request, 'proiect_licenta/user_account.html', args)
    return render(request, 'proiect_licenta/user_account.html', {'comments': comments})
